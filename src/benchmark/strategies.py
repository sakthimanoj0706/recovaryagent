...
class IntelligentRecoveryStrategy(RecoverAIRecoveryStrategy):
    ...
    def execute_lifecycle(self, lifecycle: SyntheticLifecycle, costs: CostModelConfig) -> ExecutionResult:
        ...
        intel_service.candidate_generator.config.retry_cost = costs.gateway_attempt_cost
        intel_service.candidate_generator.config.escalation_cost = costs.manual_escalation_cost
        intel_service.candidate_generator.config.chargeback_risk_cost = costs.hard_decline_penalty_cost
